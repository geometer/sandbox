...
B.opposite_side_constraint(C, A.segment(E))
A.opposite_side_constraint(D, B.segment(E))
C.same_side_constraint(E, A.segment(B))
D.same_side_constraint(E, A.segment(B))
...
#        LengthsInequalityProperty(F.segment(D), A.segment(D)),
    ...
    #    D.angle(A, F),
    #    F.angle(A, D),
    #    LineAndTwoPointsProperty(A.segment(B), E, D, same_side=True),
    #    LineAndTwoPointsProperty(A.segment(B), D, F, same_side=True),
    #    LineAndTwoPointsProperty(A.segment(B), E, D, same_side=True),
    #    LineAndTwoPointsProperty(B.segment(D), A, E, same_side=True),
    #    LineAndTwoPointsProperty(D.segment(E), B, A, same_side=True),
    #    LineAndTwoPointsProperty(A.segment(E), B, D, same_side=True),
    #    LineAndTwoPointsProperty(A.segment(D), B, E, same_side=False),
    #    LineAndTwoPointsProperty(B.segment(E), A, D, same_side=False),
    #    PointInsideAngleProperty(C, B.angle(A, D)),
    #    LineAndTwoPointsProperty(A.segment(C), M, D, same_side=True),
    #    E.angle(F, M),
    #    M.angle(E, F),
    #    F.angle(E, M),
    #    A.angle(E, D),
