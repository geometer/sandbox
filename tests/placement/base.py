...
from sandbox import PlacementHelper
...
class PlacementTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.helper = PlacementHelper(self.placement)
    ...
    def assertDistance(self, pt0, pt1, distance):
        self.assertLess(
            np.fabs(self.helper.distance(pt0, pt1) - np.float128(distance)),
            PlacementTest.ERROR,
    ...
    def assertEqualDistances(self, pt0, pt1, pt2, pt3):
        self.assertLess(
            np.fabs(self.helper.distance(pt0, pt1) / self.helper.distance(pt2, pt3) - 1),
            PlacementTest.ERROR,
    ...
    def assertDistanceRatio(self, pt0, pt1, pt2, pt3, ratio):
        self.assertLess(
            np.fabs(self.helper.distance(pt0, pt1) / self.helper.distance(pt2, pt3) - ratio),
            PlacementTest.ERROR,
    ...
    def assertAngle(self, pt0, pt1, pt2, pt3, value):
        self.assertLess(
            np.fabs(np.fabs(self.helper.angle(pt0, pt1, pt2, pt3)) - value),
            PlacementTest.ERROR,
    ...
    def assertEqualSignedAngles(self, pt0, pt1, pt2, pt3, pt4, pt5, pt6, pt7):
        self.assertLess(
            np.fabs(self.helper.angle(pt0, pt1, pt2, pt3) - self.helper.angle(pt4, pt5, pt6, pt7)),
            PlacementTest.ERROR,
